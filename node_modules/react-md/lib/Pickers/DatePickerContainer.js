...
var _isDateEqual = require('../utils/DateUtils/isDateEqual');

var _isDateEqual2 = _interopRequireDefault(_isDateEqual);

var _addDate = require('../utils/DateUtils/addDate');
...
var DatePickerContainer = function (_PureComponent) {
  ...
  function DatePickerContainer(props) {
    ...
    if (typeof props.value !== 'undefined') {
      ...
      value = typeof defaultValue === 'string' ? defaultValue : DateTimeFormat(locales, _this._getFormatOptions()).format(defaultValue);
    } else {
      date = new Date();
      value = '';
    }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this._handleOkClick = function (e) {
    ...
    var value = DateTimeFormat(locales, _this2._getFormatOptions()).format(_this2.state.calendarTempDate);
    if (onChange) {
  ...
  this._setCalendarTempDate = function (calendarTempDate) {
    var _props5 = _this2.props,
        ...
        DateTimeFormat = _props5.DateTimeFormat,
    ...
    if (autoOk) {
      var value = DateTimeFormat(locales, _this2._getFormatOptions()).format(calendarTempDate);
      if (onChange) {
